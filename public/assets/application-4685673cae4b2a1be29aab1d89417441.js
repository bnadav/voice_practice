...
function Stop (){
  ...
  $('#'+tmp_id+'_1').removeClass("stop_on stop_off pause").addClass("play"); 
  $('#'+tmp_id+'_2').removeClass("play stop_on pause").addClass("stop_off"); 
  //document.getElementById(tmp_id+'_1').style.backgroundImage="url('/play.bmp')"; 
  //document.getElementById(tmp_id+'_2').style.backgroundImage="url('/stop_off.bmp')"; 
...
function ClusterPlayClick(id,filename,maxindex){
  ...
  files = new Array(); //remove okd data from the array; 
  files.length = 0;
...
function changeBmp()
{
  ...
  if (Player.paused) {//paused
    $('#'+current_id+'_1').removeClass("stop_on stop_off pause").addClass("play");
    $('#'+current_id+'_2').removeClass("stop_off pause play").addClass("stop_on");
    //document.getElementById(current_id+'_1').style.backgroundImage = "url('/play.bmp')"; 
    //document.getElementById(current_id+'_2').style.backgroundImage  = "url('/stop_on.bmp')"; 

  }

  // if (x>=3){//Play
  else{
    $('#'+current_id+'_1').removeClass("stop_on stop_off play").addClass("pause");
    $('#'+current_id+'_2').removeClass("play stop_off pause").addClass("stop_on");
    //document.getElementById(current_id+'_1').style.backgroundImage="url('/pause.bmp')"; 
    //document.getElementById(current_id+'_2').style.backgroundImage="url('/stop_on.bmp')"; 
